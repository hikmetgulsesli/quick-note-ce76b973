...
- Quick Note turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny one-page utility called Quick Note. It should show a title, one text input for a short note, a save icon button, and a small saved status line. Keep it simple, responsive, and fully client-side.
...
- Record Operations - Quick Note
- Record Editor - Quick Note
- Insights - Quick Note

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Quick Note
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Quick Note
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - Quick Note
